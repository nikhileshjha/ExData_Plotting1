...
with(project_data,plot(datetime,Voltage,type="l"))
...
legend("topright", c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), col=c("black", "red", "blue"),cex=0.75,lty=1)
with(project_data,plot(datetime,Global_reactive_power,type="l"))
